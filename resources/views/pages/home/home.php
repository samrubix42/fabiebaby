...
new class extends Component
{
    ...
    public array $slides = [
        [
            ...
            'badge' => 'Dermatologist Tested 24H Care',
            'badgeColor' => 'bg-sky-blue text-white',
            'title' => 'Nourishing Organic Skincare for Sensitive Skin',
            'subtitle' => 'Enriched with Chamomile & Oat',
            'description' => 'Pure, soothing plant-based lotion that protects and restores your baby’s natural skin barrier.',
            'buttonText' => 'Explore Organic Skincare',
            'buttonClass' => 'bg-soft-purple hover:bg-deep-purple text-white shadow-purple-400/30',
            'category' => 'Skincare',
        ],
        [
            'bgImage' => '/images/slider1.jpg',
            'badge' => 'Pure & Natural Softness',
            'badgeColor' => 'bg-soft-purple text-white',
            'title' => 'Gentle as a Mother’s Touch, Pure as Nature',
            'subtitle' => '100% Organic Bamboo Diapers',
            'description' => 'Crafted with 12-hour instant absorbency core and 0% harmful chemicals for total skin comfort.',
            'buttonText' => 'Shop Ultra Soft Diapers',
            'buttonClass' => 'bg-vibrant-rose hover:bg-pink-600 text-white shadow-vibrant-rose/30',
            'category' => 'Diapers',
        ],
        [
            'bgImage' => '/images/slider3.jpg',
            'badge' => '99.9% EDI Pure Water Wipes',
            'badgeColor' => 'bg-pastel-green text-white',
            'title' => 'Unscented & Extra Thick Cotton Water Wipes',
            'subtitle' => 'Zero Alcohol • Zero Fragrance',
            'description' => 'Ultra-gentle pH 5.5 balanced wipes designed for newborn face, hands, and sensitive skin.',
            'buttonText' => 'Shop Pure Water Wipes',
            'buttonClass' => 'bg-vibrant-rose hover:bg-pink-600 text-white shadow-vibrant-rose/30',
            'category' => 'Wipes',
        ],
    ];
    ...
    public function with(): array
    {
        ...
        return [
            ...
            'activeSlide' => $this->slides[$this->currentSlide],
        ];
    }
};
